(() => {
    ...
    const labelWireless = document.querySelector(".label-wireless");
    const inputWireless = document.querySelector(".input-disabled");
    if (labelWireless) labelWireless.addEventListener("click", (function(e) {
        if (inputWireless) inputWireless.classList.toggle("_input-active");
    }));
    ...
    validator.addField("#FirstName", [ {
        ...
        rule: "required"
    } ]).addField("#tooltips_favorite_animal_select", [ {
        rule: "required"
    } ], {
        tooltip: {
            position: "top"
